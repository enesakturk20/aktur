  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      <div className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-green-500/5 rounded-full blur-[100px] pointer-events-none transform -translate-x-1/3 translate-y-1/4"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              <div className="inline-block mb-4">
                <span className="bg-green-100 text-green-700 px-4 py-1.5 rounded-full text-sm font-semibold tracking-wide border border-green-200">
                  Kurumsal
                </span>
              </div>
